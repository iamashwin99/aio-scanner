...
st.set_page_config(page_title="Correlation Studies", page_icon="📊", layout="wide", initial_sidebar_state="expanded")
st.markdown("# Correlation Studies 📊")
st.sidebar.markdown("# Correlation Studies📊")
